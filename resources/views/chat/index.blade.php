...
<div class="flex flex-col sm:flex-row h-screen overflow-hidden">
    ...
    <div id="sidebar" class="w-full sm:w-80 bg-white border-r border-gray-200 flex flex-col h-screen sm:h-auto">
        ...
        <div class="p-4">
            <div class="relative">
                <input type="text" placeholder="Search" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <div class="p-4 border-t border-gray-200">
            <button class="w-full bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 transition duration-150 ease-in-out flex items-center justify-center">
